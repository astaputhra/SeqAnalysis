package com.project.seqAnalysis.algorithms.sequentialpatterns.clospan_AGP;
/*
...
import com.project.seqAnalysis.algorithms.sequentialpatterns.clospan_AGP.items.Sequence;
import com.project.seqAnalysis.algorithms.sequentialpatterns.clospan_AGP.items.SequenceDatabase;
import com.project.seqAnalysis.algorithms.sequentialpatterns.clospan_AGP.items.creators.AbstractionCreator;
...
public class AlgoCloSpan extends AbstractAlogrithamClass {
     ...
     * @throws IOException
     */
    public void runAlgorithm(SequenceDatabase database, boolean keepPatterns, boolean verbose, String outputFilePath, boolean outputSequenceIdentifiers,String algorithmName1) throws IOException {
        ...
        cloSpan(database, keepPatterns, verbose, findClosedPatterns, executePruningMethods, outputFilePath, outputSequenceIdentifiers,algorithmName1);
     ...
     * @throws IOException 
     */
    protected void cloSpan(SequenceDatabase database, boolean keepPatterns, boolean verbose, boolean findClosedPatterns, boolean executePruningMethods, String outputFilePath, boolean outputSequenceIdentifiers,String algorithmName) throws IOException {
