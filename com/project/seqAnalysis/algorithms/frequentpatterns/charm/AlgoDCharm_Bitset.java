 ...
 * 
 * @see com.project.seqAnalysis.datastructures.triangularmatrix.TriangularMatrix
	...
	void save(int[] prefix, int[] suffix, BitSetSupport tidset) throws IOException {
		...
		if (!hash.containsSupersetOf(itemset, hashcode)) {
			...
			if (writer == null) { 
				...
				com.project.seqAnalysis.patterns.itemset_array_integers_with_tids_bitset.Itemset itemsetWithTidset = new com.project.seqAnalysis.patterns.itemset_array_integers_with_tids_bitset.Itemset(prefixSuffix, null, tidset.support);
