package com.project.seqAnalysis.algorithms.frequentpatterns.charm;
...
import com.project.seqAnalysis.algorithms.ArraysAlgos;
import com.project.seqAnalysis.datastructures.triangularmatrix.TriangularMatrix;
import com.project.seqAnalysis.input.transaction_database_list_integers.TransactionDatabase;
import com.project.seqAnalysis.patterns.itemset_array_integers_with_tids_bitset.Itemsets;
 ...
 * @see com.project.seqAnalysis.patterns.itemset_array_integers_with_tids_bitset.Itemset
 * @see com.project.seqAnalysis.patterns.itemset_array_integers_with_tids_bitset.Itemsets
...
loopJ:		for(int j=i+1; j < frequentItems.size(); j++) {
	...
	void save(int[] prefix, int[] suffix, BitSetSupport tidset) throws IOException {
		...
		com.project.seqAnalysis.patterns.itemset_array_integers_with_count.Itemset itemset = new com.project.seqAnalysis.patterns.itemset_array_integers_with_count.Itemset(prefixSuffix);
		...
		if (!hash.containsSupersetOf(itemset, hashcode)) {
			...
			if (writer == null) {
				...
				com.project.seqAnalysis.patterns.itemset_array_integers_with_tids_bitset.Itemset itemsetWithTidset = new com.project.seqAnalysis.patterns.itemset_array_integers_with_tids_bitset.Itemset(prefixSuffix, tidset.bitset, tidset.support);
